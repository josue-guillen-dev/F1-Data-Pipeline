...
with col_graf1:
    ...
    top_5_pilotos = df_filtrado.groupby('nombre')['puntos'].sum().reset_index()
    # 1. Filtramos y nos quedamos SOLO con los nombres y el año
    df_top_5 = top_5_pilotos.sort_values('puntos' , ascending=False).head(10)
    ...
    if len(df_top_5) == 1:
        ...
        st.line_chart(df_top_5.fillna(0))
